class ficha:
    ...
    def get_classe(self):
        if self.classe == "":
            ...
            print(self.classe)
#monge, psiônico e místico removidos
#acólito substituído por bardo
#caçador substituído por artífice

    def set_bonus_de_classe(classe):
        if classe in ["Bárbaro", "Guerreiro", "Paladino"]:
            arquetipo = [3, 1]
            recomendacao = "Força e Vigor"
        elif classe in ["Artífice", "Ladino", "Bardo"]:
            arquetipo = [2, 2]
            recomendacao = "Agilidade e Carisma"
        elif classe in ["Druida", "Mago", "Clérigo"]:
